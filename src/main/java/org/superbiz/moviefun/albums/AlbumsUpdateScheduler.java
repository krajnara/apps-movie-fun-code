...
public class AlbumsUpdateScheduler {
    ...
    public AlbumsUpdateScheduler(AlbumsUpdater albumsUpdater, DataSource ds) {
        this.ds = ds;
    ...
    public void run() {
        try {
            ...
            if(startAlbumSchedulerTask()) {
                logger.info("Start of album update...");
                albumsUpdater.update();
                logger.info("Album update complete.");
            }
            else {
                logger.info("Another update running. Skipping...");
            }
